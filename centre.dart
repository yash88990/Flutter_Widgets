...
class CenterDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("All Center Widget Codes")),
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // 4. Center with widthFactor & heightFactor
            Center(
              widthFactor: 1.5,
              heightFactor: 1.5,
              child: Container(
            ...
            Row(
              ...
              children: [
                Text("Left"),
                Center(child: Text("Middle", style: TextStyle(fontSize: 18))),
                Text("Right"),
              ],
            ),
            ...
            Container(
              ...
              child: Center(
                child: Text(
                  "Center inside Column / Container",
                  style: TextStyle(fontSize: 18),
                ),
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Center(child: Text("This is Center → always middle")),
                  SizedBox(height: 10),
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text("This is Align → custom alignment"),
                  ),
                ],
              ),
            ),
            ...
            // 10. Nested Centers (rare but possible)
            Center(
              child: Center(
                child: Center(
                  child: Text("Nested Centers (not recommended)"),
                ),
              ),
            ),
